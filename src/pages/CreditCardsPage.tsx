      ...
      <div className="page-banner">
        <div className="container">
          <div className="page-banner-inner">
            ...
            <h1>Credit Cards</h1>
            <p>Earn more, pay less, and stay in control with Nexus Bank credit cards.</p>
          </div>
        </div>
      </div>
        ...
        <div className="container">
          <div className="two-col">
            <div>
              ...
              <p>Nexus Bank credit cards offer cashback, travel rewards, and purchase protection — with no annual fee on our entry-level card. Manage your card, set spending limits, and freeze your card instantly via the app.</p>
